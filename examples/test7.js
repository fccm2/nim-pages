...
function insert_469762089(x_469762091, x_469762091_Idx, item_469762092, i_469762093) {
    var it_469762113 = ({x: 0, y: 0});
    x_469762091[x_469762091_Idx] = x_469762091[x_469762091_Idx] || []; x_469762091[x_469762091_Idx].splice(i_469762093, 0, it_469762113);
    x_469762091[x_469762091_Idx][chckIndx(i_469762093, 0, (x_469762091[x_469762091_Idx]).length - 1)] = nimCopy(x_469762091[x_469762091_Idx][chckIndx(i_469762093, 0, (x_469762091[x_469762091_Idx]).length - 1)], item_469762092, NTI469762051);

  
}

function draw_c_469762080(x_469762081, y_469762082) {
    ctx_469762056.beginPath();
    ctx_469762056.fillStyle = 'rgb(240, 180, 20)';
    ctx_469762056.arc(x_469762081, y_469762082, 22, 0, 2 * Math.PI);
    ctx_469762056.fill();

  
}

function mouse_event_469762083(m_469762084) {
    var rect_469762085 = cnv_469762055.getBoundingClientRect();
    var x_469762086 = subInt(m_469762084.clientX, rect_469762085.left);
    var y_469762087 = subInt(m_469762084.clientY, rect_469762085.top);
    var p_469762088 = {x: x_469762086, y: y_469762087};
    insert_469762089(circles_469762061[0], "list", p_469762088, 0);
    draw_c_469762080(x_469762086, y_469762087);

  
}
window.addEventListener('mousedown', mouse_event_469762083);
