...
var p_469762053 = [{x: 0, y: 0}];
var cnv_469762054 = document.getElementById("c1");
var ctx_469762055 = cnv_469762054.getContext('2d');
...
function key_event_469762070(k_469762071) {
    var c_469762072 = k_469762071.keyCode;
    switch (c_469762072) {
    case 37:
      p_469762053[0].x = subInt(p_469762053[0].x, 30);
      break;
    case 39:
      p_469762053[0].x = addInt(p_469762053[0].x, 30);
      break;
    case 38:
      p_469762053[0].y = subInt(p_469762053[0].y, 30);
      break;
    case 40:
      p_469762053[0].y = addInt(p_469762053[0].y, 30);
      break;
    default: 
      break;
    }
...
function draw_bg_469762065() {
    ctx_469762055.beginPath();
    ctx_469762055.fillStyle = 'rgb(255, 255, 255)';
    ctx_469762055.rect(0, 0, 330, 240);
    ctx_469762055.fill();

  
}

function draw_r_469762066(x_469762067, y_469762068) {
    ctx_469762055.beginPath();
    ctx_469762055.fillStyle = 'rgb(10, 230, 80)';
    ctx_469762055.rect(x_469762067, y_469762068, 30, 30);
    ctx_469762055.fill();

  
}

function animate_469762069() {
    draw_bg_469762065();
    draw_r_469762066(p_469762053[0].x, p_469762053[0].y);

  
}
window.addEventListener('keydown', key_event_469762070);
setInterval(animate_469762069, 166);
